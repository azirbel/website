export const meta = {
  ...
  banner:
    'https://playbook-beta.imgix.net/5f54fef7-5733-4eee-a8ea-659d784f725a',
  bannerColor: '#EFF0F5',
  tags: ['projects', 'indie'],
}
...
<img src="/static/img/npoint-saved.png" />
...
<img src="/static/img/npoint-basic.png" />
...
<img src="/static/img/npoint-schema-error.png" />
...
<img src="/static/img/npoint-landscape.png" />
...
<blockquote className="twitter-tweet" data-lang="en">
  <p lang="en" dir="ltr">
    Tip when evaluating libraries: check if it&#39;s blazing fast. If it&#39;s
    fast, but the README doesn&#39;t specify whether its fastness is blazing,
    keep searching. Often you can find a similar library that does the same
    thing, but blazingly. Blazing means good.
  </p>
  &mdash; Andrew Clark (@acdlite) <a href="https://twitter.com/acdlite/status/974390255393505280?ref_src=twsrc%5Etfw">March 15, 2018</a>
</blockquote>

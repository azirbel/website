export const meta = {
  ...
  banner:
    'https://playbook-beta.imgix.net/5ad8c39d-bec0-4baf-9a83-b89e547d4aa9',
  series: 'escape',
  tags: ['personal'],
}
...
<img className="more-padded shadow" src="/static/img/meet-founders.png" />
...
<img className="more-padded shadow" src="/static/img/ab-1.png" />

With a thrilling name like "About Page Copy", I was pretty sure nobody would
bother to investigate.

<img className="more-padded shadow" src="/static/img/ab-2.png" />
...
<img className="padded shadow" src="/static/img/return-to-about.png" />

export const meta = {
  ...
  tags: ['projects', 'indie'],
  banner:
    'https://playbook-beta.imgix.net/63d207a9-e576-4bbe-9ea3-2ca0e66c32a0',
  bannerColor: '#d1d3d8',
}
...
_(I had a lot of fun with the landing page and put an easter egg in. You'll
know when you've found it.)_
...
<img src="/static/img/tbt-preferences.png" />
...
<img src="/static/img/mute-me.png" />

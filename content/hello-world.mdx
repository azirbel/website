export const meta = {
  ...
  banner:
    'https://playbook-beta.imgix.net/7a781bd8-e8fe-4968-978b-352baec4d2b4',
  tags: ['personal'],
}
...
blogs](https://blog.ghost.org/private-blogs/), but that's not quite
enough - if someone shares or leaks the password you picked, how would
you know?

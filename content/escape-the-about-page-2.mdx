...
*Previous in series: [Episode 1](/escape-the-about-page-1)*
<br/>
*Next in series: [Episode 3](/return-to-the-about-page)*
...
<img class="padded shadow" src="/static/img/diff1-split.png" />

Pretty suspicious, right?

And here it is in unified mode:

<img class="padded shadow" src="/static/img/diff1-unified.png" />
...
<img class="padded shadow" src="/static/img/diff1-description.png" />
...
<img class="center medium" src="/static/img/diff1-lgtm.png" />
...
<img class="padded shadow" src="/static/img/diff2-description.png" />

In split mode, the real change looked like this:

<img class="padded shadow" src="/static/img/diff2-split.png" />
...
<img class="padded shadow" src="/static/img/diff2-chat1.png" />
...
<img class="center medium" src="/static/img/diff2-visnu1.png" />
...
<img class="center medium" src="/static/img/diff2-visnu2.png" />

Nolan got back from lunch and the rest is history.

<img class="padded shadow" src="/static/img/diff2-chat2.png" />

<img class="center medium" src="/static/img/diff2-lgtm.png" />
...
<img class="padded shadow" src="/static/img/diff3-description.png" />
